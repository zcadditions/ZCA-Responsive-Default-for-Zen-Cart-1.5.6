...
//-bof-zca_diy_tpl  *** 2 of 2 ***
if (!isset($_SESSION['layoutType'])) {
  $_SESSION['layoutType'] = 'desktop';
}
...
if ( $detect->isMobile() && !$detect->isTablet() && $_SESSION['layoutType'] == 'full' || $detect->isTablet() && $_SESSION['layoutType'] == 'full' || $_SESSION['layoutType'] == 'full' ){
    ...
    echo '<link rel="stylesheet" type="text/css" href="' . $template->get_template_dir('.css',DIR_WS_TEMPLATE, $current_page_base,'css') . '/' . 'responsive_mobile.css' . '" />';
  } else if ( $detect->isTablet() || $_SESSION['layoutType'] == 'tablet' ){
    echo '<link rel="stylesheet" type="text/css" href="' . $template->get_template_dir('.css',DIR_WS_TEMPLATE, $current_page_base,'css') . '/' . 'responsive_tablet.css' . '" />';
  } else {
  echo '<link rel="stylesheet" type="text/css" href="' . $template->get_template_dir('.css',DIR_WS_TEMPLATE, $current_page_base,'css') . '/' . 'responsive_default.css' . '" />'; 
  }
}
//-eof-zca_diy_tpl  *** 2 of 2 ***
